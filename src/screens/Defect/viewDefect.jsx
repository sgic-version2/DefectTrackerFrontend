        ...
        const columns = [
            ...
            },
            {
                ...
                render: (Item, key) => <Button.Group>
                    <Button secondary onClick={() => this.handleOpenEdit(key)}>Edit</Button>
                    <Button.Or />
                    <Button negative
                        onClick={() =>
                ...
                <Grid direction="row" container>
                    <Grid item xs={11} style={{ marginTop: '2%' }}>
                        <Segment>
                            ...
                            <EditDefect open={this.state.value} handleOpen={this.handleOpenEdit} handleClose={this.handleCloseEdit} selectedData={this.state.selectedID} />
