    ...
    render() { 
        ...
        <Grid direction="row" container>
           <Grid item xs={11} style={{ marginTop: '2%' }}>
              <Segment>
                 <BreadCrumbs />
                 <PriorityAdd open={this.state.open} handleOpen={this.handleOpen} handleClose={this.handleClose} changeDataValues={this.props.changeDataValues}  />
                 <EditPriority open={this.state.value} handleOpen={this.handleOpenedit} handleClose={this.handleCloseedit}   />
                 <Button className="primary" onClick={this.handleOpen} >Add Priority</Button>
