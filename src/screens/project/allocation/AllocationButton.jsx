...
const AllocationButton = ({ roleAllocation, deAllocation, employeeData }) => {
  ...
  return (
    <div>
      ...
      <Model
        ...
        width={90}
        form={<RoleAllocation roleAllocation={roleAllocation} deAllocation={deAllocation} employeeData={employeeData} />}
