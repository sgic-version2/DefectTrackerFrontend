...
import DesignationConfig from '../../screens/Designation/DesignationConfig';
import RoleConfig from '../../screens/Role/RoleConfig';
      ...
      >
        <Grid item xs={12} style={useStyles.subContainer}>
          <Switch>
            ...
            <Route path='/defect/role' component={RoleConfig} />
            <Route path='/defect/designation' component={DesignationConfig} />
